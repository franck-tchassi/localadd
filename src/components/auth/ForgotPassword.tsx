    ...
    <div className="h-screen min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 flex flex-col justify-center h-full">
        ...
        <button
          ...
          className="w-full mt-4 flex justify-center py-2 px-4 border cursor-pointer border-gray-300 rounded-2xl shadow-sm text-base font-medium text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors duration-200"
        >
          Annuler
        </button>
      </div>
