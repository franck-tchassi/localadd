...
const LocalVisibilityRanking = () => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-orange-100 w-full max-w-md mx-auto mt-8">
            ...
            <div className="p-4 bg-gradient-to-r from-orange-400 to-orange-500">
                ...
                >
                    <div className="relative w-full">
                        ...
                        />
                        <Search className="absolute right-4 top-1/2 -translate-y-1/2 text-orange-400 w-5 h-5" />
                    </div>
                </form>
            </div>
            {/* Classement */}
                    ...
                    filtered.map((company, index) => (
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div
                                    className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-orange-500 bg-orange-100 border border-orange-300`}
                                >
                                    {index + 1}
                                </div>
                                <div>
