        ...
        <section className="py-12 bg-white">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="text-5xl font-bold  mb-8">
                    Plus de{" "}
                    <span className="count text-orange-600">
                ...
                <div className="flex flex-wrap justify-center gap-16 mt-12">
                    {partners.map((partner) => (
                        <div
                            key={partner.id}
                            className="w-32 h-32 relative    flex items-center justify-center hover:scale-105 hover:border-orange-500 transition-all group"
                        >
                            <Image
                                src={partner.logo}
                                alt={partner.alt}
