            ...
            <div className="container mx-auto px-4 py-12 flex flex-col items-center justify-center">
                <div className="w-full max-w-3xl mx-auto flex flex-col items-center text-center space-y-8">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight">
                        ...
                        <span className="text-gray-900">, la solution SaaS pour booster votre présence locale</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
                        Centralisez, optimisez et synchronisez tous vos canaux digitaux (Google, réseaux sociaux, annuaires...) depuis une seule plateforme intuitive.<br />
                        Gagnez en visibilité, attirez plus de clients et pilotez votre réputation locale avec des outils d'automatisation avancés.
                    </p>
