...
function CheckoutForm() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-orange-100">
            <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 bg-white rounded-3xl shadow-2xl p-8 border border-orange-100">
                {/* Colonne gauche : récapitulatif commande */}
                <div className="border-r border-gray-100 pr-8 flex flex-col justify-between">
                    <div>
                        <h2 className="font-bold text-orange-500 mb-6 text-base">Récapitulatif de la commande</h2>
                        {stripeLoading ? (
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col gap-2">
                                    <div className="text-4xl font-extrabold text-orange-600 flex items-baseline justify-end">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex flex-row justify-between items-center text-lg font-semibold mt-2">
                                        ...
                                        <span className="text-orange-500">{total.toFixed(2)} {currency}</span>
                                    </div>
                                </div>
                                <Separator className="my-2" />
                ...
                <div className="pl-12 flex flex-col h-full justify-between">
                    <div className="flex items-center justify-center mb-8 gap-2 select-none">
                        {step === 'onboarding' ? (
                            <span className="text-orange-500 font-bold cursor-default">Vos coordonnées</span>
                        ) : (
                            <button
                                type="button"
                                className="text-gray-900 font-bold underline underline-offset-2 hover:text-orange-600 transition-colors cursor-pointer"
                        ...
                        <span className={step === 'payment' ? 'text-orange-500 font-bold' : 'text-gray-400'}>Paiement</span>
                    </div>
                    ...
                    {step === 'onboarding' && (
                        ...
                        <form className="space-y-8" onSubmit={e => {
                            ...
                            <input
                                ...
                                required
                                className="block w-full px-3 py-2 border border-orange-200 rounded-2xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-base"
                            />
                            <input
                                type="text"
                                placeholder="Pays"
                            ...
                            <button
                                type="submit"
                                className="flex-1 flex justify-center py-2 px-4 border cursor-pointer border-transparent rounded-2xl shadow-sm text-base font-medium text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors duration-200"
                            >
                                Continuer
                            </button>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8 flex flex-col h-full justify-between">
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className={`block w-full px-3 py-2 border rounded-2xl shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 mb-2 ${cardNameError ? 'border-red-600' : 'border-orange-200'}`}
                                        value={cardName}
                                        onChange={e => {
                                ...
                                <div className="flex gap-6">
                                    <div className="flex-1">
                                        ...
                                        <div
                                            className={`block w-full px-3 py-2 border rounded-2xl shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 ${cardExpiryError ? 'border-red-600' : 'border-orange-200'}`}
                                        >
                                            <CardExpiryElement
                                                options={{
                                                    style: {
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div
                                            className={`block w-full px-3 py-2 border rounded-2xl shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 ${cardCvcError ? 'border-red-600' : 'border-orange-200'}`}
                                        >
                                            <CardCvcElement
                                                options={{
                                                    style: {
                            ...
                            <div className="flex gap-4 mt-8 justify-end">
                                <button
                                    type="button"
                                    onClick={() => setStep('onboarding')}
                                    className="px-6 py-2 rounded-2xl border border-orange-200 text-orange-500 bg-white hover:bg-orange-50 font-semibold shadow-sm transition-colors duration-200"
                                >
                                    Retour coordonnées
                                </button>
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="px-6 py-2 rounded-2xl border border-transparent shadow-sm text-base font-medium text-white bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-all duration-200"
                                >
